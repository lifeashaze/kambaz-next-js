...
- [x] Options include text + icons (3/2/1/0)
- [x] Wide screen: sidebars + modules (3/2/1/0)
- [x] Narrow screen: hide sidebars (3/2/1/0)
- [x] Module titles: grey bg, icon left, controls right (3/2/1/0)
- [x] At least 2 modules (3/2/1/0)
- [x] Lessons: white bg, green border left, icon + controls (3/2/1/0)
- [x] At least 2 lessons (3/2/1/0)
- [x] Layout generally correct (3/2/1/0)
...
- [x] Assignments link not selected in sidebar (3/2/1/0)
- [x] Breadcrumb minimal (3/2/1/0)
- [x] Inputs styled with `form-control` (3/2/1/0)
- [x] Fields placed correctly (3/2/1/0)
- [x] Use Bootstrap grid/flex (3/2/1/0)
- [x] White space with Bootstrap margin/padding (3/2/1/0)
- [x] Calendar icons optional (3/2/1/0)
- [x] Date format flexible (3/2/1/0)
- [x] Layout generally correct (3/2/1/0)
