...
## Kanbas - Navigation
- [x] Links: Northeastern, Account, Dashboard, Courses, Calendar, Inbox, Labs (3/2/1/0)
- [x] Northeastern: logo + link (3/2/1/0)
- [x] Account: black bg, white text/icon (3/2/1/0)
- [x] Dashboard: white bg, red text/icon (3/2/1/0)
- [x] Others: black bg, white text, red icon (3/2/1/0)
- [x] General nav styling correct (3/2/1/0)

## Kanbas - Dashboard
- [x] Courses grid (3/2/1/0)
- [x] Responsive wrapping (3/2/1/0)
- [x] Equal width courses (3/2/1/0)
- [x] Margins around courses (3/2/1/0)
- [x] Background in cards (solid/image) (3/2/1/0)
- [x] At least 3 courses (3/2/1/0)
- [x] Layout generally correct (3/2/1/0)
- [x] Left sidebar navigation (3/2/1/0)
- [x] Right: dashboard/courses fill space (3/2/1/0)

## Kanbas - Course Navigation
- [x] Links: Home, Module, Piazza, Zoom, Assignments, Quizzes, Grades, People (3/2/1/0)
- [x] White background (3/2/1/0)
- [x] Red link text (3/2/1/0)
- [x] Active: black left border + text (3/2/1/0)
- [x] Active default: Home (3/2/1/0)
- [x] Styling generally correct (3/2/1/0)

## Kanbas - Modules
- [ ] Buttons: Collapse All, View Progress, + Module (3/2/1/0)
- [ ] Collapse/View: black on grey (3/2/1/0)
- [ ] + Module: white on red (3/2/1/0)
- [ ] Publish all dropdown (3/2/1/0)
- [ ] Options include text + icons (3/2/1/0)
- [ ] Wide screen: sidebars + modules (3/2/1/0)
- [ ] Narrow screen: hide sidebars (3/2/1/0)
- [ ] Module titles: grey bg, icon left, controls right (3/2/1/0)
- [ ] At least 2 modules (3/2/1/0)
- [ ] Lessons: white bg, green border left, icon + controls (3/2/1/0)
- [ ] At least 2 lessons (3/2/1/0)
...
- [ ] Breadcrumb minimal (3/2/1/0)
- [ ] Inputs styled with `form-control` (3/2/1/0)
- [ ] Fields placed correctly (3/2/1/0)
- [ ] Use Bootstrap grid/flex (3/2/1/0)
- [ ] White space with Bootstrap margin/padding (3/2/1/0)
- [ ] Calendar icons optional (3/2/1/0)
- [ ] Date format flexible (3/2/1/0)
- [ ] Layout generally correct (3/2/1/0)
